...
local TASKS_BY_LEVEL = {
  ...
  [3]={
    ...
    "summer_elves","deathlings","great_pearl","nagas","carnisylvans", "seacrest"
  },
  [4]={
...
local function handleRagnarAvailableList(text)
  ...
  for _,key in ipairs(levelTasks) do
    ...
    -- Só considera disponível se o NPC falou E ela ainda não está concluída
    if task and spoken[ragnarListName(task.label)] and cfg.completed[key]~=true then
      available[key]=true
      found=found+1
    end
  end
  ...
  for _,key in ipairs(levelTasks) do
    -- IMPORTANTE: task já concluída nunca é desmarcada pelo NPC
...
local RUNES = {
    [3175] = { -- Stone Shower
        "Goblin", "Goblin Assassin", "Goblin Leader", "Goblin Scavenger",
        "Frost Troll", "Orc", "Orc Spearman", "Orc Warrior", "Orc Shaman", "Orc Rider", "Orc Berserker", "Orc Leader", "Orc Warlord",
        "Cyclops", "Cyclops Smith", "Cyclops Drone", "Barbarian Bloodwalker", "Barbarian Brutetamer", "Barbarian Headsplitter", "Barbarian Skullhunter", "Stonerefiner",
        "Barkless Devotee", "Barkless Fanatic", "Orc Cult Fanatic", "Orc Cult Inquisitor", "Orc Cult Minion", "Orc Cult Priest", "Orc Cultist",
        "Pirat Scoundrel", "Pirat Cutthroat", "Pirat Bombardier", "Warlock",
        "Angry Sugar Fairy", "Candy Floss Elemental", "Goggle Cake", "Sparkion", "Breach Brood", "Dread Intruder", "Reality Reaver",
        "Two-headed Turtle", "Makara", "Naga Archer", "Naga Warrior", "Seacrest Serpent", "Sea Serpent"
    },

    [3202] = { -- Thunderstorm
        "Minotaur", "Minotaur Archer", "Minotaur Guard", "Minotaur Mage",
        "Quara Mantassin", "Quara Mantassin Scout", "Quara Constrictor", "Quara Constrictor Scout", "Quara Pincher", "Quara Pincher Scout",
        "Quara Predator", "Quara Predator Scout", "Quara Hydromancer", "Quara Hydromancer Scout",
        "Bluebeak", "Bramble Wyrmling", "Crusader", "Hawk Hopper", "Headwalker", "Lion Hydra",
        "Faun", "Dark Faun", "Nymph", "Pooka", "Twisted Pooka",
        "Deepling Spellsinger", "Deepling Scout", "Deepling Warrior", "Deepling Guard",
        "Frost Dragon", "Frost Dragon Hatchling", "Medusa", "Serpent Spawn", "Hydra", "Eternal Guardian",
        "Choking Fear", "Retching Horror", "Silencer",
        "Fury", "Grim Reaper", "Candy Horror", "Nibblemaw", "Honey Elemental", "Dawnfire Asura", "Frost Flower Asura",
        "Juggernaut", "Cliff Strider", "Ironblight", "Orewalker", "Deathling Scout", "Deathling Spellsinger", "Foam Stalker"
    },

    [3191] = { -- GFB
        "Dwarf", "Dwarf Soldier", "Dwarf Guard", "Dwarf Geomancer",
        "Dworc Venomsniper", "Dworc Voodoomaster", "Dworc Fleshhunter",
        "Mummy", "Ghoul", "Scarab", "Mutated Rat", "Mutated Human", "Mutated Bat", "Mutated Tiger",
        "Corym Charlatan", "Corym Skirmisher", "Corym Vanguard",
        "Pirate Marauder", "Pirate Cutthroat", "Pirate Corsair", "Pirate Buccaneer",
        "Necromancer", "Zombie", "Gravedigger", "Blood Hand", "Ancient Scarab", "Giant Spider",
        "Tortoise", "Toad", "Blood Crab", "Thornback Tortoise",
        "Cult Believer", "Vicious Squire", "Cult Enforcer", "Renegade Knight", "Vile Grandmaster", "Cult Scholar", "Hero", "Swan Maiden",
        "Werefox", "Werebadger", "Wereboar", "Werebear", "Werewolf",
        "Glooth Bandit", "Glooth Brigand", "Exotic Cave Spider", "Exotic Bat", "Pirat Mate",
        "Waspoid", "Crawler", "Lumbering Carnivor", "Spiky Carnivor", "Menacing Carnivor",
        "Burster Spectre", "Ripper Spectre", "Thanatursus", "Arachnophobica", "Hideous Fungus", "Humongous Fungus",
        "Weretiger", "White Weretiger", "Cunning Werepanther", "Soul-broken Harbinger",
        "Crazed Winter Vanguard", "Crazed Winter Rearguard",
        "Dark Carnisylvan", "Hulking Carnisylvan", "Poisonous Carnisylvan"
    }
}
